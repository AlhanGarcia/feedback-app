...
This is a project from the React Front To Back 2022 udemy course from bradtraversy. It allows users to add, update and delete feedback. It uses a mock REST api with json-server.
